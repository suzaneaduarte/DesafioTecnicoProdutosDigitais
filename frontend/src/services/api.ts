...
const initialProducts: Product[] = [
  {
    ...
    price: 5.99,
    description: 'Chocolate ao leite Nestlé Classic 90g ao leite',
  ...
  },
  {
    ...
    name: 'Franuí',
    price: 29.57,
    description: 'Framboesas banhadas em chocolate branco e chocolate ao leite',
  ...
  },
    {
      ...
      price: 1.69,
      description: 'Salgadinho de galinha levemente crocante com toque suave de galinha caipira',
    ...
    },
    {
      ...
      price: 8.79,
      description: 'Nuggets de frango crocante contendo saborosas 10 unidades de nuggets de frango',
